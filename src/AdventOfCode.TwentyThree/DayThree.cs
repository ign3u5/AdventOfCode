...
public class DayThree : IChallenge<int>
{
  public string ChallengeInputPath { get; } = DataProvider<DayThree>.GetChallengePath();
    ...
    public int RunTaskOne(string[] lines)
    {
        ...
        for (int lNum = 0; lNum < lines.Length; lNum++) {
            ...
            for (int cNum = 0; cNum < currentLine.Length; cNum++) {
                ...
                bool isBottomLine = lNum == lines.Length - 1;
                ...
                bool isSpecial(int xDelta, int yDelta) => lines[lNum + yDelta][cNum + xDelta] != '.' && !char.IsDigit(lines[lNum + yDelta][cNum + xDelta]);
    ...
    public record Gear(int numberOfParts, int gearRatio);
    ...
    public int RunTaskTwo(string[] lines)
    {
        ...
        for (int lNum = 0; lNum < lines.Length; lNum++) {
            ...
            for (int cNum = 0; cNum < currentLine.Length; cNum++) {
                ...
                bool isSpecial(int xDelta, int yDelta) => lines[lNum + yDelta][cNum + xDelta] == '*';
